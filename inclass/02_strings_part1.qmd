...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2026/blob/main/02_strings_part1.qmd).
Just hit the Download Raw File button.

You can also see a video walkthrough of the first half of this worksheet [here](https://stolaf.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=37f8aa60-ca36-4916-83a7-af410143c055)
...
spot_smaller |>
  ...
  select(title, artist, album_release_year)
```
